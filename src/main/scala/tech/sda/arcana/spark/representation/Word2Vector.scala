...
object Word2Vector {
  ...
  def main(args: Array[String]) {
    ...
    val model = new WordToVec()
    model.load("/home/elievex/Repository/word2vec-scala/vectors.bin")
     // model.load("/home/elievex/Resources/vectors.bin")
...
//    model.pprint(model.rank("apple", Set("orange", "soda", "lettuce")))
    ...
    model.pprint(model.distance(List("man"), N = 10))
  }
